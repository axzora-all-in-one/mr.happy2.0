  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-fintech': 'linear-gradient(135deg, hsl(217, 91%, 60%) 0%, hsl(262, 83%, 58%) 100%)',
        'gradient-success': 'linear-gradient(135deg, hsl(142, 76%, 36%) 0%, hsl(158, 64%, 52%) 100%)',
        'gradient-warning': 'linear-gradient(135deg, hsl(38, 92%, 50%) 0%, hsl(45, 100%, 51%) 100%)',
      ...
      boxShadow: {
        ...
        'fintech': '0 10px 25px -3px rgba(59, 130, 246, 0.15), 0 4px 6px -2px rgba(59, 130, 246, 0.05)',
